...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("DRXE");
    case mBTC: return QString("mDRXE");
    case uBTC: return QString::fromUtf8("μDRXE");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Droxnes"));
    case mBTC: return QString(QObject::tr("Milli-Droxnes (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Droxnes (1 / 1,000,000)"));
    default: return QString("???");
    }
}
