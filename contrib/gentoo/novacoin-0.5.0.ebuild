...
src_install() {
	...
	newins "src/qt/res/icons/Droxne-128.png" "${PN}.png"

	make_desktop_entry "${PN}-qt" "Droxne" "/usr/share/pixmaps/${PN}.png" "Network;P2P;Finance;"

	if use kde; then
		insinto /usr/share/kde4/services
		newins contrib/debian/Droxne-qt.protocol ${PN}.protocol
	fi
}
